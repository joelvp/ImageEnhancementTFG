...
import models.low_light.code.models.modules
import models.low_light.code.models.modules.Permutations
from models.low_light.code.models.modules import flow, thops, FlowAffineCouplingsAblation
...
class FlowStep(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels,
        ...
        # 1. actnorm
        self.actnorm = models.low_light.code.models.modules.FlowActNorms.ActNorm2d(in_channels, actnorm_scale)

        # 2. permute
        if flow_permutation == "invconv":
            self.invconv = models.low_light.code.models.modules.Permutations.InvertibleConv1x1(
                in_channels, LU_decomposed=LU_decomposed)

        # 3. coupling
        if flow_coupling == "CondAffineSeparatedAndCond":
            self.affine = models.low_light.code.models.modules.FlowAffineCouplingsAblation.CondAffineSeparatedAndCond(in_channels=in_channels,
                                                                                                opt=opt)
