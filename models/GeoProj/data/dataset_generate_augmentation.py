...
parser.add_argument("--sourcedir", type=str, default='C:/Users/JoelVP/Desktop/UPV/ImageEnhancementTFG/models/GeoProj/dataset/demo_images3')
...
parser.add_argument("--trainnum", type=int, default=96, help='number of the training set')
parser.add_argument("--testnum", type=int, default=32, help='number of the test set')
...
def filter_size_images(folders, img_width_dataset, img_height_dataset):
    ...
    for image_file in image_files:
        ...
        image_width, image_height = Image.open(source_path).size
...
if __name__ == '__main__':
    ...
    img_width_dataset = 512
    img_height_dataset = 512
